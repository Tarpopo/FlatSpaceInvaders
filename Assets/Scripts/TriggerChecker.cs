...
public class TriggerChecker<T>
{
    ...
    public void OnTriggerEnter2D(Collider2D other) => TryAddItem(other.gameObject);

    public void OnTriggerStay2D(Collider2D other) => TryAddItem(other.gameObject);

    public void OnTriggerExit2D(Collider2D other) => TryRemoveItem(other.gameObject);
